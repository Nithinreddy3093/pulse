        ...
        <div className="text-center mb-5">
          ...
          <p className="text-xs text-[#64748B] mt-1">
            {mode === 'forgot-password'
              ...
              : 'Sign in to access persistent cloud watchlists and your personalized baseline tracking.'}
          </p>
        </div>
        ...
        {mode !== 'forgot-password' && (
          <div className="mb-4">
            ...
            >
              ...
              <span className="ml-auto text-[10px] bg-[#10B981]/20 text-[#10B981] px-2 py-0.5 rounded font-bold">
                Active
              </span>
            </button>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-3 top-2.5 text-[#94A3B8] hover:text-[#0F1B3D] cursor-pointer"
              >
        ...
        {mode === 'forgot-password' ? (
          ...
          <div className="mt-4 pt-3 border-t border-[#E2E8F0] text-center">
            <button
              ...
              disabled={loading}
              className="text-xs text-[#64748B] hover:text-[#0F1B3D] font-medium cursor-pointer"
            >
              Try Anonymous Guest Session
            </button>
          </div>
        )}
      </div>
